...
public class InterestView extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Perform action on click
            	Log.d(Micropublisher.LOG_TAG, "Cancel clicked");
            	finish();
            }
        });
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
    	...
    	case KeyEvent.KEYCODE_BACK:
    		Log.d(Micropublisher.LOG_TAG,"Key back, creating added/deleted interests bundle");
	...
	public void parseEntry() {
    	...
    	for (int i = 0; i < split.length; i++) {
    		...
    		Log.d(Micropublisher.LOG_TAG, "Entry." + interest);
	...
	// Called from Micropublisher.java in a callback from Haggle (other thread)
